...
const About = () => {
  ...
  const teamMember = {
    name: "Muhammed Fayiz",
    role: "Founder & CEO",
    description: "Passionate about connecting people with amazing events through BookItNow. Creating seamless experiences for event organizers and attendees.",
  ...
  return (
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-600 leading-relaxed">
              At BookItNow, we're committed to creating a seamless platform where event organizers and attendees connect effortlessly. 
              Our goal is to make event discovery and booking as simple as possible while ensuring quality experiences for everyone.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-gray-100">
        <div className="container mx-auto px-6">
          <h2 className="text-3xl font-bold text-center mb-12 text-gray-800">Why Choose BookItNow?</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white rounded-lg p-8 shadow-lg text-center">
              <div className="text-blue-600 text-4xl mb-4">🎯</div>
              <h3 className="text-xl font-semibold mb-4">Easy Booking</h3>
              <p className="text-gray-600">Book your favorite events with just a few clicks</p>
            </div>
            <div className="bg-white rounded-lg p-8 shadow-lg text-center">
              <div className="text-blue-600 text-4xl mb-4">🌟</div>
              <h3 className="text-xl font-semibold mb-4">Verified Performers</h3>
              <p className="text-gray-600">Quality entertainment from trusted professionals</p>
            </div>
            <div className="bg-white rounded-lg p-8 shadow-lg text-center">
              <div className="text-blue-600 text-4xl mb-4">💬</div>
              <h3 className="text-xl font-semibold mb-4">24/7 Support</h3>
              <p className="text-gray-600">Always here to help with your booking needs</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-6">
          <h2 className="text-3xl font-bold text-center mb-12 text-gray-800">Meet the Founder</h2>
          <div className="max-w-2xl mx-auto">
            <div className="bg-white rounded-lg p-8 shadow-lg text-center">
              <div className="mb-6">
                <div className="w-40 h-40 mx-auto bg-gray-200 rounded-full mb-4"></div>
                <h3 className="text-2xl font-semibold mb-2">{teamMember.name}</h3>
