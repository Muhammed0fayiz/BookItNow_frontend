          ...
          <div className="fixed inset-0 bg-gray-800 bg-opacity-75 z-50">
            <div className="fixed right-0 top-0 w-64 h-full bg-white shadow-lg z-50">
              ...
              <div className="flex flex-col p-6">
                ...
                <a onClick={profilePage} className="text-gray-700 hover:text-blue-600 transition duration-300">
                  Profile
                </a>
              </div>
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-gray-600">Connect with performers and book amazing events.</p>
            </div>
            <div>
              <h4 className="text-lg font-semibold mb-4">Quick Links</h4>
              <ul className="space-y-2">
                <li><a href="/home" className="text-gray-600 hover:text-blue-600">Home</a></li>
                <li><a href="/events" className="text-gray-600 hover:text-blue-600">Events</a></li>
