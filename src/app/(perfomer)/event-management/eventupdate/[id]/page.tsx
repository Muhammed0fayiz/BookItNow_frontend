...
const EventForm: React.FC = () => {
    ...
    const fetchEvent = async () => {
      try {
        ...
        setFormData({
          ...
          teamLeader: eventData.teamLeader || '',
          teamLeaderNumber: eventData.teamLeaderNumber || '',
  ...
  const validateField = (name: keyof FormData, value: any): string => {
    if (name === 'imageFile') {
      if (!value && !imagePreview && !isEditing) return 'Image is required';
      return '';
    }
        ...
        <div className="bg-white rounded-t-2xl shadow-lg p-6 mb-1">
          ...
          <div className="text-center mt-6">
            ...
            <p className="text-gray-500 mt-2">
              {isEditing ? 'Update your event details below' : 'Fill in the details to create your amazing event'}
            </p>
          </div>
        </div>
